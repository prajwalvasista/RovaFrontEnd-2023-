  ...
  String getStageData(String cropName, String stage) {
    if (stage == 'Stage I: About The Crop') {
      if (cropName == 'Tomato') {
        ...
        return '''
          Mango (Mangifera Indica) is the most ancient among the tropical fruits and is believed to have originated in the Indo-Burma region.
        ...
        return '''
          Cucumber(Cucumis sativus) is cultivated for fresh consumption or as pickling cucumber for preservation, marinated with vinegar, salt, dill, or other spices.
