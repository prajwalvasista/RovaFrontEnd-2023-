...
class Stage4Screen extends StatelessWidget {
  ...
  String getStageData(String cropName, String stage) {
    if (stage == 'Stage IV: Fertilizer Suggestion') {
      if (cropName == 'Tomato') {
        return '''
        The fertilizer dose depends upon the fertility of the soil and the amount of organic manure applied to the crop. For a good yield, 15-20 tonnes of well-decomposed FYM is incorporated into the soil.
      ...
      ''';
        ...
        return '''
        A young orchard should be supplied with 10 kg FYM + 100 Kg Nitrogen (N) + 50 g Phosphorus (P205) + 100 g Potassium (K2O) per tree in the first year, and it should be increased with age.
